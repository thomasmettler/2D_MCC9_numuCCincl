...
outputdir = inputdir+'plots/G3_uB/' 
...
# load file with other generator predictions comming from e.g nuisance
...
#h_true = f_gen.Get('h_rate_neut')
#h_true = f_gen.Get('h_rate_nuwro')
#h_true = f_gen.Get('h_rate_gibuu')
#h_true = f_gen.Get('h_rate_g3')
#h_true = f_gen.Get('h_rate_g2')
...
CC.eventrate_comparison(h_data,h_true,2.144e+20,frac_tot, 'EventRate_Neut','Neut')
